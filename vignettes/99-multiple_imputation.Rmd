...
cbind(df.before, df.mean)       # merge the two data frames
...
cbind(df.before, df.regression)       # merge the two data frames
...
cbind(df.before, df.pmm)       # merge the two data frames
...
plot(activity$interval[289:17568], Sti[1:limRow], 
     col = colvec, 
     # type="l", 
     xlab="Observation", 
     ylab="Steps")
