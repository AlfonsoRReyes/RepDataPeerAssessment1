...
## Imputing random values and density plot
...
y.obs <- data.frame(imp$data$steps[indNA.not])
summary(y.obs)
dim(y.obs)
names(y.obs) <- "steps"
...
steps.imp <- imp$imp$steps$`1`   # all imputed values
