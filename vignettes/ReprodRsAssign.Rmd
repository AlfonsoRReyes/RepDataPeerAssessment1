...
```{r}
# save the dataset in the pkg base
activity <- read.csv(paste(project.extdata, "activity.csv", sep = "/"))
save(activity, file=paste(project.data, "activity.RData", sep = "/"))
activity
```

```{r}
# save the dataset in the project folder
act <- read.csv(paste(extPath, "activity.csv", sep = "/"))
save(act, file=paste(project.data, "act.RData", sep = "/"))
# rm(activity)
```

```{r}
load(paste(project.data, "act.RData", sep = "/"))
act
```
...
file.exists(paste(dataPath, "act.RData", sep = "/"))
```
